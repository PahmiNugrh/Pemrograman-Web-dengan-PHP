    ...
    <center>
        ...
        ?>
            ...
            <table border="1">
                ...
                <tr>
                    <td>Air PDAM <?php echo $rb_air; ?></td>
                    <td align="right">Rp.
                        <?php
                        if ($rb_air == "PDAM") {
                            $rb_air = 20000;

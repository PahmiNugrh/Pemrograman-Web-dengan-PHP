...
<body>
    <div align="center"><br />
        PERHITUNGAN PENJUALAN BARANG 2c.php
    </div>
    <br /><br />
    <form method="post" action="" target="_self">
        <table width="300" border="1" align="center">
            ...
            <tr>
                <td>Status</td>
                <td>
                    <input type="radio" name="status_member" id="member" value="member" /> Member
                    <br />
                    <input type="radio" name="status_member" id="bukan_member" value="bukan_member" /> Bukan Member
                </td>
            </tr>
            <tr>
                <td>Kota Kirim</td>
    ...
    if($submit) {
        ...
        if ($status_member=="member") {
            ...
            $ket_status="Member";
        } elseif ($status_member=="bukan_member") {
            $diskon_status=0;
        ...
        if ($kota_kirim=="Jakarta") {
            $ongkos_kirim=10000;
        } elseif ($kota_kirim=="Bandung") {
            $ongkos_kirim=12500;
        } elseif ($kota_kirim=="Padang") {
            $ongkos_kirim=30000;
        } elseif ($kota_kirim=="Yogyakarta") {
            $ongkos_kirim=20000;
        }
